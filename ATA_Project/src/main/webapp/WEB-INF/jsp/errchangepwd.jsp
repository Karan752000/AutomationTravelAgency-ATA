...
<body>
	...
	<div class="container mt-5 bg-light">
		<div class="container-fluid ">
			...
			<h3 align="center" style="color: red;"><small>${msg}</small></h3>
			<form action="changepwd" method="post">
				<!-- <div class="form-group">
					<label for="emailId">Registered Email Id:</label><br> <input
						type="email" class="form-control"
						placeholder="Enter Registered Email" name="emailId" pattern="[a-zA-Z0-9]+@gmail.com" required>
				</div> -->
				<div class="form-group">
...
<br>
<label for="passwordold">old</label>
<input type="password" name="passwordold" placeholder="enter old password">
<br>
<label for="passwordnew">new</label>
<input type="password" name="passwordnew" placeholder="enter old password">
<br>
